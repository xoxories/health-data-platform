...
// Stroke-currentColor, sized via the `size` prop (also accepts width/height
// via spread). Ported from frontend/_design-reference/icons.jsx into a
// proper ES module (no window.X assignment).
...
export const ICON_PATHS = {
  ...
  pill: (
    <>
      ...
      <path d="M8 8 16 16" transform="rotate(-30 12 12)" />
    </>
  ),
  brain: (
    <>
  ...
  syringe: (
    <>
      ...
      <path d="m11 9 7 7" />
      <path d="m7 13 4 4" />
      <path d="M3 21l4-1 6-6-3-3-6 6z" />
    </>
  ),
  scalpel: (
    <>
      <path d="M3 21 14 10l4 4-11 11z" />
      <path d="M14 10 21 3 14 3z" />
    </>
  ),
  // Lock / crypto
  lock: (
  ...
  ipfs: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M12 3v18M3 12h18M5 7c4 3 10 3 14 0M5 17c4-3 10-3 14 0" />
    </>
  ),
  network: (
    <>
      ...
      <path d="M12 7v3M12 13l-5.5 4.5M12 13l5.5 4.5" />
    </>
  ),
  filter: (
    <>
  ...
  scroll: (
    <>
      <path d="M19 17V5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2h2z" />
  ...
  flame: (
    <>
      <path d="M12 3s5 5 5 10a5 5 0 0 1-10 0c0-3 2-4 2-7 1 1 3 2 3-3z" />
    </>
  ),
};

export function Icon({ name, size = 18, className = "", strokeWidth = 1.7, ...rest }) {
